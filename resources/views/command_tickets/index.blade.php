...
<div x-data="window.commandTicketsPage()">
    ...
    <x-common.component-card title="Historial de comandas" desc="Consulta comandas impresas y no impresas, revisa su contenido o vuelve a imprimirlas.">
        <form method="GET" class="mb-5 grid gap-3 md:grid-cols-2 xl:grid-cols-6 xl:items-end">
            ...
            <div class="flex gap-2"><button class="h-11 flex-1 rounded-lg bg-[#111827] px-4 text-sm font-semibold text-white"><i class="ri-search-line mr-1"></i>Buscar</button><a href="{{ route('command-tickets.index') }}" class="flex h-11 items-center rounded-lg border border-gray-300 px-3 text-gray-600"><i class="ri-refresh-line"></i></a></div>
        </form>

        <div class="overflow-x-auto rounded-xl border border-gray-200">
            <table class="w-full min-w-[950px] text-sm">
                <thead class="bg-[#111827] text-white"><tr><th class="px-4 py-3 text-left">Fecha</th><th class="px-4 py-3 text-left">Impresora</th><th class="px-4 py-3 text-center">Estado</th><th class="px-4 py-3 text-center">Intentos</th><th class="px-4 py-3 text-left">Error</th><th class="px-4 py-3 text-center">Acciones</th></tr></thead>
