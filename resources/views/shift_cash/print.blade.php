        ...
        <div class="section">
            ...
            <table>
                <thead>
                    <tr>
                        <th>Producto</th>
                        <th class="text-right">Stock inicial (Había)</th>
                        <th class="text-right">Vendidos</th>
                        <th class="text-right">Stock final (Quedó)</th>
                ...
                <tbody>
                    @forelse($r['products_sold'] ?? [] as $row)
                        <tr>
                            <td>{{ $row['product'] }}</td>
                            <td class="text-right">{{ number_format($row['stock_initial'] ?? ($row['stock_final'] + $row['qty']), 2) }}</td>
