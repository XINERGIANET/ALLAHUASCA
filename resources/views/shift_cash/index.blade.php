                ...
                <form method="GET" class="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center">
                    ...
                    <div class="relative flex w-full sm:w-auto min-w-[200px]">
                        <select 
                            ...
                            "
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-[#111827] focus:ring-[#111827]/10 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                    ...
                    <div class="flex gap-2">
                        <x-ui.button size="md" variant="primary" type="submit" class="h-11 px-4" style="background-color: #09090b;">
                                ...
                                <td colspan="8" class="px-5 py-6 sm:px-6">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl mx-auto">
                                        ...
                                        <div class="mx-auto w-full max-w-xl space-y-1 text-center text-gray-800 dark:text-gray-200">
                                            <p class="font-bold text-[#111827] uppercase text-xs mb-2">Información de Apertura</p>
