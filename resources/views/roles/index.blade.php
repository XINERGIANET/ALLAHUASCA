        ...
        <x-common.component-card title="Listado de roles" desc="Gestiona los roles registrados en el sistema.">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="dark:bg-dark-900 shadow-theme-xs focus:border-[#111827] focus:ring-[#111827]/10 dark:focus:border-[#111827] h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 pl-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                            />
                        </div>
                    </div>
            ...
            <div class="table-responsive mt-4 rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                <table class="w-full min-w-max">
                    <thead>
                        <tr class="text-white">
                            <th style="background-color: #111827; color: #FFFFFF;" class="px-3 py-3 text-center sm:px-6 first:rounded-tl-xl sticky-left-header">
