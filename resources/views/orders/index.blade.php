...
@section('content')
    ...
    <div class="mx-3 md:mx-4 flex flex-col gap-4 rounded-2xl border border-gray-200 bg-white dark:bg-gray-900 p-4">
        <div x-data="posSystem()" x-cloak
            ...
            style="--brand:#111827; --brand-soft:rgba(255,70,34,0.14);">
                ...
                <div class="flex flex-col lg:flex-row items-stretch lg:items-center gap-4 w-full">
                        ...
                        <div class="w-full min-w-0 flex-1">
                            <div class="flex items-center gap-2 w-full">
                                <button
                                    ...
                                    class="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-500 shadow-sm transition hover:border-[#111827]/30 hover:text-[#111827] dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300"
                    ...
                    <div class="relative w-full lg:w-[380px] xl:w-[460px] shrink-0 min-w-0 flex items-center gap-2">
                        <input type="text" x-model="searchQuery" @keydown.enter.prevent="addSearchChip"
                            ...
                            class="w-full pl-10 pr-4 py-2.5 text-sm bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl text-gray-800 dark:text-gray-200 placeholder-gray-400 focus:ring-2 focus:ring-[#111827]/30 focus:border-[#111827] outline-none transition-all">
                        <x-ui.button size="xs" variant="primary" type="button" onclick="addSearchChip()" class="!px-1.5 !py-1.5 text-[11px] font-normal h-auto leading-tight" style="background-color: #111827; border-color: #111827;">Añadir filtro</x-ui.button>
                    </div>
