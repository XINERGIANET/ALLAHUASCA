    ...
    <div class="flex flex-col gap-5 md:flex-row">
        <div class="w-full md:w-1/3">
            ...
            <select name="person_type" x-model="personType" @change="onPersonTypeChange()"
                class="h-12 w-full rounded-xl border border-gray-300 bg-white px-4 text-sm text-gray-800 focus:border-[#111827] focus:ring-2 focus:ring-[#111827]/20 focus:outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-white">
        ...
        <div class="w-full md:w-2/3">
            ...
            <div class="flex flex-col gap-3 sm:flex-row">
                <input type="text" name="document_number" x-model.trim="documentNumber"
                    ...
                    class="h-12 w-full rounded-xl border border-gray-300 bg-white px-4 text-sm text-gray-800 placeholder:text-gray-400 focus:border-[#111827] focus:ring-2 focus:ring-[#111827]/20 focus:outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-white" />
