        ...
        <div class="rounded-xl bg-white border border-gray-200 shadow-sm p-6">
                    ...
                    <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                        ...
                        <div class="relative">
                            <input type="text" name="moved_at" x-ref="movedAtInput"
                                ...
                                class="h-10 w-full rounded-lg border border-gray-300 px-3 pr-10 text-sm focus:border-[#111827] focus:outline-none focus:ring-1 focus:ring-[#111827] bg-white"
                                required />
                            <i
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <div>
                                ...
                                <select name="document_type_id"
                                    class="h-10 w-full rounded-lg border border-gray-300 px-3 text-sm focus:border-[#111827] focus:outline-none focus:ring-1 focus:ring-[#111827] bg-white"
                                    required>
                            ...
                            <div>
                                ...
                                <input type="text" name="series"
                                    class="h-10 w-full rounded-lg border border-gray-300 px-3 text-sm focus:border-[#111827] focus:outline-none focus:ring-1 focus:ring-[#111827]"
            ...
            'description' => trim(($person->first_name ?? '') . ' ' . ($person->last_name ?? '')) . ' - ' . ($person->document_number ?? '')
                            ...
                            <button type="button" @click="openModalCreateProveedor()"
                                class="px-4 py-2 rounded-lg text-sm font-medium transition-colors bg-[#111827] text-white hover:bg-[#09090b]">
                    ...
                    <div x-show="showModalProveedor" x-cloak
                        ...
                        <div class="w-full max-w-2xl rounded-2xl border border-gray-200 bg-white shadow-2xl dark:border-gray-700 dark:bg-gray-900"
                            ...
                            {{-- Header --}}
                            <div class="flex items-center justify-between border-b border-gray-200 px-6 py-4 dark:border-gray-700 bg-gradient-to-r from-[#111827]/5 to-transparent rounded-t-2xl">
                                <div class="flex items-center gap-3">
                                    <div class="flex h-9 w-9 items-center justify-center rounded-xl bg-[#111827]/10">
                                        <i class="ri-user-add-line text-[#111827] text-lg"></i>
                                    </div>
                                    <div>
                            ...
                            <div class="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
                                ...
                                @php $iC = 'h-11 w-full rounded-xl border border-gray-300 bg-white px-4 text-sm text-gray-800 placeholder:text-gray-400 focus:border-[#111827] focus:ring-2 focus:ring-[#111827]/20 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white'; @endphp
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-2">
                                        <select x-model="providerForm.person_type" @change="onSupplierTypeChange()"
                                            class="h-11 w-32 shrink-0 rounded-xl border border-gray-300 bg-white px-3 text-sm text-gray-800 focus:border-[#111827] focus:ring-2 focus:ring-[#111827]/20 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white">
                            ...
                            <div class="flex justify-end gap-3 border-t border-gray-200 px-6 py-4 dark:border-gray-700 bg-gray-50/60 rounded-b-2xl">
                                ...
                                <button type="button" @click="submitProviderModal()" :disabled="providerLoading"
                                    class="px-5 py-2.5 rounded-xl text-sm font-bold text-white bg-[#111827] hover:bg-[#09090b] disabled:opacity-50 transition-colors inline-flex items-center gap-2">
                    ...
                    <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                        ...
                        <div class="relative mb-4">
                            ...
                            <input type="text" x-model="catalogSearch" placeholder="Buscar por nombre o categoría"
                                class="h-10 w-full rounded-lg border border-gray-300 pl-10 pr-3 text-sm focus:border-[#111827] focus:outline-none focus:ring-1 focus:ring-[#111827]" />
                        </div>
                        <div class="flex flex-wrap gap-2 mb-4">
                            <button type="button" @click="selectedCategory = null"
                                class="px-4 py-2 rounded-lg text-sm font-medium transition-colors"
                                :class="selectedCategory === null ? 'bg-[#111827] text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'">
                                General
                            </button>
                            <template x-for="cat in categories" :key="cat.id">
                                <button type="button" @click="selectedCategory = cat.id"
                                    class="px-4 py-2 rounded-lg text-sm font-medium transition-colors"
                                    :class="selectedCategory === cat.id ? 'bg-[#111827] text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'"
                                    x-text="cat.name">
                                </button>
                            </template>
                        </div>
                        <div
                            ...
                            <template x-for="product in filteredCatalogProducts" :key="product.id">
                                <button type="button" @click="addProductToCart(product)"
                                    class="flex flex-col rounded-xl border border-gray-200 bg-white p-3 text-left hover:border-[#111827] hover:shadow-md transition-all group">
                                    <div class="relative aspect-square mb-2 rounded-lg bg-gray-100 overflow-hidden">
                                        ...
                                        <span
                                            class="absolute top-1 right-1 px-1.5 py-0.5 rounded text-[10px] font-bold bg-[#111827]/90 text-white"
                                            x-text="'Stock: ' + (product.stock ?? 0)"></span>
                                    </div>
                                    <p class="text-xs font-medium text-gray-800 line-clamp-2 mb-1" x-text="product.name">
                                    </p>
                                    <p class="text-sm font-bold text-[#111827]" x-text="money(product.cost)"></p>
                                </button>
                            </template>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex border-b border-gray-200">
                            <button type="button" @click="activeTab = 'resumen'"
                                ...
                                :class="activeTab === 'resumen' ? 'bg-[#111827] text-white' : 'text-gray-600 hover:bg-gray-50'">
                                Resumen
                            </button>
                            <button type="button" @click="activeTab = 'pago'"
                                class="flex-1 px-4 py-3 text-sm font-semibold transition-colors"
                                :class="activeTab === 'pago' ? 'bg-[#111827] text-white' : 'text-gray-600 hover:bg-gray-50'">
                                Pago
                            </button>
                        </div>
                            ...
                            <div x-show="activeTab === 'resumen'" x-cloak class="space-y-4">
                                <div class="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <select name="tipo_detalle"
                                            class="h-9 w-full rounded-lg border border-gray-300 px-2 text-sm focus:border-[#111827] focus:ring-1 focus:ring-[#111827] bg-white">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="tax_rate_percent" x-model.number="taxRate" step="0.01"
                                            min="0" max="100"
                                            class="h-9 w-full rounded-lg border border-gray-300 px-2 text-sm focus:border-[#111827] focus:ring-1 focus:ring-[#111827]"
                                            required>
                                    </div>
                                    <div>
                                        <label
                                                ...
                                                <div class="flex items-center gap-2 mt-2">
                                                    <div class="w-2/3 relative">
                                                        ...
                                                        <div class="relative">
                                                            ...
                                                            <input type="number" x-model.number="item.amount" min="0"
                                                                step="0.01"
                                                                class="w-full pl-6 pr-2 py-1.5 text-xs font-bold text-gray-700 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:border-[#111827] focus:ring-1 focus:ring-[#111827] outline-none transition-colors"
                                                    ...
                                                    <div class="w-1/3 flex justify-end items-end pt-3">
                                                        <p class="text-[10px] text-gray-500 text-right"><span
                                                                class="font-bold text-[#111827] block text-xs"
                                ...
                                <div class="mt-4 pt-4 border-t-2 border-gray-200">
                                    ...
                                    <div
                                        ...
                                        <span
                                            ...
                                            A PAGAR</span>
                                        <span class="text-xl font-black text-[#111827] text-right"
                                ...
                                <div>
                                    ...
                                    <textarea name="comment" rows="2"
                                        class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#111827] focus:ring-1 focus:ring-[#111827]"
                            ...
                            <div x-show="activeTab === 'pago'" x-cloak class="space-y-2">
                                <div>
                                    ...
                                    <select name="payment_type" x-model="payment_type"
                                        class="h-10 w-full rounded-lg border border-gray-300 px-3 text-sm focus:border-[#111827] focus:ring-1 focus:ring-[#111827] bg-white">
                                    ...
                                    <div class="grid grid-cols-2 gap-3">
                                        <div>
                                            ...
                                            <input type="number" min="0" step="1" name="credit_days"
                                                ...
                                                class="h-10 w-full rounded-lg border border-orange-300 bg-white px-3 text-sm focus:border-[#111827] focus:ring-1 focus:ring-[#111827]">
                                        </div>
                                        <div>
                                            <label
                                ...
                                <div x-show="payment_type === 'CONTADO'" class="space-y-3">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <button type="button" @click="addPaymentRow()"
                                            class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-[#111827] text-white text-xs font-bold hover:bg-[#09090b] transition-colors">
                        ...
                        <div class="flex gap-3 justify-end shrink-0 mb-3 mr-3">
                            ...
                            <button type="submit"
                                class="inline-flex items-center rounded-lg bg-[#111827] px-6 py-2.5 text-sm font-bold text-white shadow-md hover:bg-[#09090b] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
