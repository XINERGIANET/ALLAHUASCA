                ...
                <table class="w-full min-w-max">
                        <thead class="text-left text-theme-xs dark:text-gray-400">
                            <tr class="border-b border-gray-100 dark:border-gray-800">
                                <th style="background-color: #111827; color: #FFFFFF;" class="px-5 py-3 text-center sm:px-6 sticky-left-header">
                                    ID
                                </th>
                                <th style="background-color: #111827; color: #FFFFFF;" class="px-5 py-3 text-center sm:px-6">
                                    Descripcion
                                </th>
                                <th style="background-color: #111827; color: #FFFFFF;" class="px-5 py-3 text-center sm:px-6">
                                    Valor
            ...
            <div>
                <form method="GET" action="{{ route('admin.parameters.index') }}">
                    ...
                    <select
                        ...
                        class="dark:bg-dark-900 shadow-theme-xs focus:border-[#111827] focus:ring-[#111827]/10 dark:focus:border-[#111827] h-11 w-full rounded-lg border border-gray-300 bg-transparent px-3 py-2.5 text-sm text-gray-800 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                    >
            ...
            <form id="create-parameter-form" class="space-y-4" action="{{ $viewId ? route('admin.parameters.store') . '?view_id=' . $viewId : route('admin.parameters.store') }}"
                ...
                <div>
                    ...
                    <input type="text" name="description" id="description" value="{{ old('description') }}"
                        ...
                        class="dark:bg-dark-900 shadow-theme-xs focus:border-[#111827] focus:ring-[#111827]/10 dark:focus:border-[#111827] h-11 w-full rounded-lg border {{ $errors->has('description') ? 'border-error-500' : 'border-gray-300' }} bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">
                    @error('description')
                ...
                <div>
                    ...
                    <input type="text" name="value" id="value" value="{{ old('value') }}"
                        ...
                        class="dark:bg-dark-900 shadow-theme-xs focus:border-[#111827] focus:ring-[#111827]/10 dark:focus:border-[#111827] h-11 w-full rounded-lg border {{ $errors->has('value') ? 'border-error-500' : 'border-gray-300' }} bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">
                    @error('value')
                        <p class="mt-1 text-sm text-error-500">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <select name="parameter_category_id" id="parameter_category_id"
                        ...
                        class="dark:bg-dark-900 shadow-theme-xs focus:border-[#111827] focus:ring-[#111827]/10 dark:focus:border-[#111827] h-11 w-full rounded-lg border {{ $errors->has('parameter_category_id') ? 'border-error-500' : 'border-gray-300' }} bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">
