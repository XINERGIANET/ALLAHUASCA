            ...
            <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                <form method="GET" class="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center">
                    ...
                    <div class="relative min-w-[160px]">
                        <select
                            name="role_id"
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-[#111827] focus:ring-[#111827]/10 dark:focus:border-[#111827] h-11 w-full rounded-lg border border-gray-300 bg-transparent px-3 py-2 text-sm text-gray-700 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90"
                        >
            ...
            <div class="table-responsive mt-4 rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
                <table class="w-full min-w-max border-separate border-spacing-0">
                    <thead class="text-white">
                        <tr style="background-color: #111827;" class="text-white text-theme-xs uppercase tracking-wider">
                            ...
                            <tr class="group/row transition hover:bg-gray-50/80 dark:hover:bg-white/5">
                                <td class="px-4 py-4 text-center sticky-left">
                                    <button type="button"
                                        ...
                                        class="inline-flex h-6 w-6 items-center justify-center rounded-full bg-[#111827] text-white transition hover:bg-[#09090b] dark:bg-[#111827] dark:text-white">
