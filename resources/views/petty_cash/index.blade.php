...
@section('content')
    ...
    <div x-data="{
        ...
        @if (session('closed_shift_id'))
            <div class="mb-5 flex flex-col gap-4 rounded-2xl border border-emerald-200 bg-emerald-50 p-4 shadow-sm sm:flex-row sm:items-center sm:justify-between dark:border-emerald-500/30 dark:bg-emerald-500/10">
                ...
                <x-ui.button type="button" size="md" variant="primary"
                    className="shrink-0 bg-[#111827] text-white"
        ...
        <x-common.component-card title="Gestión de Movimientos" desc="Control de ingresos, egresos y traslados de fondos.">
            ...
            @php
                $selectFilterClass = 'dark:bg-dark-900 shadow-theme-xs focus:border-[#111827] focus:ring-[#111827]/10 dark:focus:border-[#111827] h-11 w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm text-gray-800 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 cursor-pointer';
                $inputFilterClass = 'dark:bg-dark-900 shadow-theme-xs focus:border-[#111827] focus:ring-[#111827]/10 dark:focus:border-[#111827] h-11 w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90';
            ...
            <div
                ...
                <table class="w-full min-w-0">
                    <thead class="bg-[#111827] text-white shadow-sm">
                        <tr>
                                ...
                                <tr
                                    ...
                                    <td class="px-3 py-3 text-center">
                                        <button type="button" @click="expanded = !expanded"
                                            class="inline-flex h-7 w-7 items-center justify-center rounded-full bg-[#111827] text-white transition hover:bg-[#09090b] hover:scale-110 active:scale-95 dark:bg-[#111827] dark:text-white">
            ...
            <div class="p-6 sm:p-8">
                <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex h-12 w-12 items-center justify-center rounded-2xl transition-colors duration-300"
                        :class="formDocId == ingresoId ? 'bg-[#111827]/10 text-[#111827]' : 'bg-red-50 text-red-500'">
