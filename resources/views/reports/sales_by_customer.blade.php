        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 mb-8">
            <form action="{{ route('reports.sales_by_customer') }}" method="GET" class="flex flex-wrap items-end gap-4">
                ...
                <div class="flex gap-2">
                    <button type="submit"
                        class="bg-[#09090b] hover:bg-[#A3311E] text-white px-6 h-11 rounded-xl font-bold text-sm transition-all flex items-center gap-2 shadow-sm">
                                    ...
                                    <td class="px-4 py-4">
                                        <div class="flex items-center gap-3 justify-center">
                                            ...
                                            <div
                                                ...
                                                <div class="h-full bg-[#111827] rounded-full" style="width: {{ $percentage }}%">
                                                </div>
                                            </div>
                                            <span
                        ...
                        new Chart(canvas, {
                            ...
                            data: {
                                ...
                                datasets: [{
                                    data: @json($chartData ?? []),
                                    backgroundColor: [
                                        '#09090b', '#F97316', '#FBBF24', '#10B981', '#3B82F6', '#6366F1', '#8B5CF6',
