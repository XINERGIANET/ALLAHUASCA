...
<head>
    ...
    <style>
        * {
        ...
        body.ticket-paper-58 .col-qty { width: 9%; }
        body.ticket-paper-58 .col-product { width: 42%; padding-left: 0.35mm; padding-right: 0.2mm; }
        body.ticket-paper-58 .col-unit { width: 21%; }
        body.ticket-paper-58 .col-subtotal { width: 28%; }
