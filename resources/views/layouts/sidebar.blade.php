                                    ...
                                    @if (!empty($item['subItems']))
                                        <button @click="toggleSubmenu({{ $groupIndex }}, {{ $itemIndex }})"
                                            ...
                                            <svg x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                                                ...
                                                :class="{
                                                    'rotate-180 text-gray-900 dark:text-white opacity-100': isSubmenuOpen({{ $groupIndex }}, {{ $itemIndex }})
                                                }"
                                        ...
                                        <a href="{{ $item['path'] }}" 
                                           ...
                                           :class="[
                                            ...
                                            <span
                                                ...
                                                @if (!empty($item['new']))
                                                    <span class="ml-2 inline-flex items-center px-2 py-0.5 rounded text-xs font-semibold bg-gray-900 text-white">new</span>
                                                @endif
                                            </span>
                                        </a>
