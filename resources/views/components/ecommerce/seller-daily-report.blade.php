    ...
    <form method="GET" action="{{ route('dashboard') }}" class="flex flex-wrap items-end gap-3 mb-6">
        ...
        <div class="flex flex-col gap-1">
            ...
            <select name="report_type"
                class="h-10 rounded-lg border border-gray-200 bg-white px-3 text-sm text-gray-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#111827]/40 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200">
        ...
        <button type="submit"
            class="h-10 rounded-lg bg-[#111827] px-5 text-sm font-semibold text-white shadow hover:bg-[#e03d1c] transition-colors flex items-center gap-1.5">
