    ...
    <div class="relative">
        @if(!$hideIcon && $iconClickEvent)
            <button
                ...
                class="absolute inset-y-0 left-1 my-auto flex h-9 w-9 items-center justify-center rounded-md text-gray-400 transition-colors hover:bg-[#09090b]/10 hover:text-[#09090b] focus:outline-none z-10"
                title="Acción"
            >
        ...
        <input
            ...
            {{ $disabled ? 'disabled' : '' }}
            class="h-11 w-full rounded-lg border border-gray-200 bg-white {{ $hideIcon ? 'pl-4' : 'pl-11' }} pr-10 text-sm text-gray-800 placeholder-gray-400 focus:border-[#09090b] focus:ring-1 focus:ring-[#09090b] dark:border-gray-700 dark:bg-dark-900 dark:text-white/90 transition-all disabled:opacity-60 disabled:cursor-not-allowed disabled:bg-gray-50 dark:disabled:bg-gray-800/80"
            autocomplete="off"
        >
        ...
        <div class="absolute inset-y-0 right-0 flex items-center pr-2">
            @if($clearable)
                ...
                <button
                    ...
                    class="flex h-8 w-8 items-center justify-center rounded-md text-gray-400 transition-colors hover:bg-gray-100 hover:text-[#09090b]"
            ...
            <ul class="py-1">
                <template x-for="item in filteredOptions" :key="item.id">
                    <li @click="selectOption(item)"
                        class="cursor-pointer px-4 py-2 text-sm text-gray-700 hover:bg-[#09090b]/5 hover:text-[#09090b] font-medium transition-colors">
