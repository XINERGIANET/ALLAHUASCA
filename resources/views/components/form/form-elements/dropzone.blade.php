<x-common.component-card title="Dropzone">
    ...
    <div 
        ...
        class="transition border border-gray-300 border-dashed cursor-pointer dark:hover:border-[#111827] dark:border-gray-700 rounded-xl hover:border-[#111827]"
    >
        <div 
            ...
            :class="isDragging 
                ? 'border-[#111827] bg-gray-100 dark:bg-gray-800' 
        ...
        >
            ...
            <div class="flex flex-col items-center m-0">
                ...
                <span class="font-medium underline text-theme-sm text-[#111827]">
                    Browse File
                </span>
            </div>
        </div>
