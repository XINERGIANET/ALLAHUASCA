...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('/ventas', SalesController::class)
        ...
        ->only(['index', 'store', 'edit', 'update', 'destroy']);
    Route::get('/admin/ventas/{sale}', [SalesController::class, 'show'])->name('sales.show');
    ...
    Route::get('/admin/ventas/eliminadas-listado', [SalesController::class, 'deletedSalesList'])->name('sales.deleted');
